...
On peut répondre « deux paquets » à la question de quantité : si les deux informations sont reconnues, Alexa passe au rayon. L'article libre reste demandé séparément ; une phrase telle que « ajoute deux bouteilles de lait » n'est pas découpée automatiquement.
...
- Essai réel de l'ajout simple confirmé par Antoine. Recette de l'extension : ouvrir « carnet familial », ajouter un article test, répondre aux précisions et vérifier quantité/unité/rayon dans Maison ; essayer « passer » puis « annuler » sans écriture. Tester aussi le second Echo. Ne pas refaire la liaison déjà réussie. Les résultats locaux ne remplacent pas ces contrôles.
