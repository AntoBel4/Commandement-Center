...
6. Endpoint HTTPS de la skill : `https://<PORTAL_HOST>/integrations/alexa`, certificat d'une autorité de confiance. Activer les essais Development. Associer personnellement le compte Maison depuis l'application Alexa et essayer les Echo réels avant de déclarer T03 terminé. Aucune publication au catalogue.
