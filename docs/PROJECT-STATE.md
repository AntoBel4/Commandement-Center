...
1. Association personnelle, transport signé et lancement normal du simulateur réussis après correction et reconstruction. Obtenir la transcription exacte du lancement sur Echo : même avec « carnet familial », il engage un dialogue jour/heure étranger à la skill. Distinguer reconnaissance et routage avant tout nouveau changement. Si nécessaire, comparer le compte actif et la disponibilité de la skill sur l’enceinte, sans désassocier Maison. Valider ensuite le premier ajout vocal dans Maison et le second Echo. PR 7 reste en brouillon jusqu’à la recette. Ensuite Google Agenda et les créneaux à double validation. T1 à T8 sont déjà validés et ne sont pas à refaire.
