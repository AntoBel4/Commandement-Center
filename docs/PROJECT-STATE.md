...
T08 : services comptes/courses installés sur Nexus ; publication de famille.estarellas.online réalisée après reprise explicitement autorisée le 18 septembre. DNS propre vers Nexus et HTTPS strict vérifiés. Le 18 septembre, Antoine confirme les mots de passe et informations des deux comptes modifiés, les deux espaces accessibles, puis l’essai Android en 4G/5G sans USB réussi (connexion, ajout d’une course, rechargement, déconnexion). Les huit tests finaux T1 à T8 sont également confirmés réussis par Antoine. Phase actuelle : Alexa courses installée pour recette, liaison et ajout simple sur Echo confirmés ; dialogue quantité/unité/rayon validé sur Echo ; saisie en une phrase installée et vérifiée dans Amazon, essai Echo attendu ; Google Agenda ensuite. Destination hors serveur toujours différée.
...
- **État actuel :** 18 septembre 2026 — Antoine confirme que l’article du dialogue quantité/unité/rayon apparaît correctement dans Maison, puis demande de tout dire en une seule phrase. Extension 57aa69d : « ajoute deux paquets de pâtes au rayon épicerie » renseigne les quatre valeurs et ajoute directement ; une phrase incomplète demande seulement les précisions absentes. Extraction limitée aux quantités françaises prises en charge, unités usuelles et rayon explicitement annoncé ; noms composés conservés, aucune information inventée. Quatorze tests Alexa et parcours réel local Keycloak/PostgreSQL réussis, avec reprise sans doublon ; CI et GitGuardian réussis. Seul Alexa recréé sur Nexus à 57aa69d, six services sains ; modèle Amazon et liaison conservés. Simulateur Amazon avec compte lié : ajout immédiat « test phrase alexa », quantité 2, unité paquet, rayon Épicerie ; valeurs relues en base, une seule ligne. Phrase partielle « deux bouteilles de test phrase partielle » : seule question du rayon, puis annulation confirmée et absence en base. Recette de la phrase complète sur Echo encore attendue ; passer/annuler sur enceinte et second Echo restent ouverts. PR 7 en brouillon. Google Agenda ensuite ; destination hors serveur différée.
- **Encore à vérifier :** phrase complète sur Echo, passer/annuler sur enceinte et second Echo. L’ajout simple et le dialogue quantité/unité/rayon sont validés. T03 reste En cours pour la fin de recette.
...
1. Vérifier sur Echo la phrase complète avec « carnet familial » : « ajoute deux paquets de pâtes test phrase au rayon épicerie », puis contrôler l’ajout direct et les quatre valeurs dans Maison. Vérifier passer/annuler et le second Echo. Ajout simple et dialogue guidé déjà confirmés. PR 7 reste en brouillon pendant cette recette ; Google Agenda ensuite. T1 à T8 ne sont pas à refaire.
