...
- T06 reste En cours : premier essai téléphone accepté par Antoine (« Oui, présent une seule fois dans les deux »). Ajout de « Test agenda » depuis Maison pour demain 10 h–11 h et présence unique aux bons horaires dans Maison et Google validés. Deuxième essai demandé : déplacer le rendez-vous dans Google à 11 h–12 h puis actualiser Maison ; résultat attendu. Partage visible chez Belinda encore à vérifier. Créneaux à double validation, rappels Telegram et capture vocale des rendez-vous restent à réaliser. [Guide et retour arrière](https://github.com/AntoBel4/Commandement-Center/blob/feat/google-calendar/docs/GOOGLE-AGENDA.md).
...
1. Recette de Google Agenda installé à 6534c0c (PR 8 brouillon) : ajout « Test agenda » depuis Maison et affichage unique dans Google acceptés sur téléphone. Attendre le résultat du déplacement dans Google à 11 h–12 h relu dans Maison, puis vérifier annulation/récurrence et partage selon le rythme accepté. Après cette tranche, réaliser les créneaux à double validation ; Telegram et rendez-vous vocaux restent dans leurs lots. Projet sans facturation, zéro dépense autorisée. Ne pas reprendre les essais Alexa dispensés ni T1 à T8.
