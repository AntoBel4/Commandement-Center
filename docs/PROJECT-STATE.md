...
Phase Alexa demandée après validation des tests T1 à T8. Ajout simple depuis Echo retrouvé dans Maison confirmé par Antoine. Extension quantité/unité/rayon installée à sa demande, recette Echo encore attendue. Google Agenda vient ensuite, puis les commandes vocales de rendez-vous.

- [PR 7 — Courses Alexa](https://github.com/AntoBel4/Commandement-Center/pull/7), branche `feat/alexa-groceries`, tête `a3aa1290c96685e3af30be2a9a2f966f056feb69` : brouillon non fusionné. Installation initiale f74f1a7 ; correctif web 702a125 puis dialogue Alexa a3aa129. Image Alexa a3aa129 sélectionnée par ALEXA_RELEASE ; API/web restent f74f1a7, aucun redémarrage de ces services pour l’extension. [Guide et limites](https://github.com/AntoBel4/Commandement-Center/blob/feat/alexa-groceries/docs/ALEXA-COURSES.md).
...
1. Vérifier sur Echo le dialogue quantité/unité/rayon avec « carnet familial » : ajout test, réponse « deux paquets », rayon « épicerie », puis contrôle des trois valeurs dans Maison. Vérifier passer/annuler et le second Echo. Ajout simple déjà confirmé. PR 7 reste en brouillon pendant la recette de l’extension ; Google Agenda ensuite. T1 à T8 ne sont pas à refaire.
