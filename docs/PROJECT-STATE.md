...
- T06 reste En cours : premier essai demandé sur téléphone, créer « Test agenda » pour demain de 10 h à 11 h dans Maison puis vérifier une présence unique et les horaires dans Maison et Google Maison - Famille. Résultat attendu, partage visible chez Belinda encore à vérifier. Créneaux à double validation, rappels Telegram et capture vocale des rendez-vous restent à réaliser. [Guide et retour arrière](https://github.com/AntoBel4/Commandement-Center/blob/feat/google-calendar/docs/GOOGLE-AGENDA.md).
...
1. Recette de Google Agenda installé à 6534c0c (PR 8 brouillon) : obtenir le résultat de l’ajout « Test agenda » depuis Maison et de son affichage unique dans Google, puis vérifier les changements/annulations/récurrences et le partage selon le rythme accepté. Après cette tranche, réaliser les créneaux à double validation ; Telegram et rendez-vous vocaux restent dans leurs lots. Projet sans facturation, zéro dépense autorisée. Ne pas reprendre les essais Alexa dispensés ni T1 à T8.
